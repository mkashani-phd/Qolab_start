...
g = QualibrationGraph(
    ...
    nodes={
        ...
        # "power_rabi_error_amplification_x180": library.nodes["08a_Power_Rabi_Error_Amplification"].copy(flux_point_joint_or_independent=flux_point, multiplexed=multiplexed, operation = "x180", name="power_rabi_error_amplification_x180"),
        # "power_rabi_error_amplification_x90": library.nodes["08a_Power_Rabi_Error_Amplification"].copy(flux_point_joint_or_independent=flux_point, multiplexed=multiplexed, operation = "x90", name="power_rabi_error_amplification_x90"),
