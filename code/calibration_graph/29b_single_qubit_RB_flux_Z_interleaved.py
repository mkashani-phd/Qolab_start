...
class Parameters(NodeParameters):
    ...
    interleaved_gate: Literal['I', 'x180', 'y180', 'z180', 'x90', '-x90', 'y90', '-y90', 'z90', '-z90'] = "z180"
...
#     name="29b_Single_Qubit_RB_flux_Z_interleaved",
#     parameters_class=Parameters
# )

node = QualibrationNode(name="29b_Single_Qubit_RB_flux_Z_interleaved", parameters=Parameters())
...
#  0: I |  1: x180 |  2: y180
# 3: z180      | 12: x90 | 13: -x90 | 14: y90 |
# 15: -y90 | 16: z90 | 17: -z90
def transfrom_gate_to_index(transformation_str):
    transformations = {
        "identity": 0,
        "x180": 1,
        "y180": 2,
    ...
    return transformations.get(transformation_str, "Invalid transformation")

interleaved_gate_index = transfrom_gate_to_index(node.parameters.interleaved_gate)
...
# %%
depths = np.arange(2, 2 * max_circuit_depth + 0.1, 2 * delta_clifford)
depths[0] = 1
