...
g = QualibrationGraph(
    ...
    nodes={
        ...
        "T1_measurement": library.nodes["05_T1"].copy(name="T1_measurement"),
        "T2_echo_measurement": library.nodes["05b_T2e"].copy(name="T2_echo_measurement"),
    },
    connectivity=[
        ...
        ("ramsey_vs_flux_calibration", "DRAG_calibration"),
        ...
        ("Randomized_benchmarking_1", "T1_measurement"),
        ("T1_measurement", "T2_echo_measurement")
    ],
