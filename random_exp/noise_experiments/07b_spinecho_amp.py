...
idle_times = (np.linspace(16, node.parameters.max_wait_time_in_ns, node.parameters.num_time_steps) // 4).astype(int)
...
T1_values = [q.T1*1e6 for q in qubits]
T1 = xr.DataArray(
    data=T1_values,
